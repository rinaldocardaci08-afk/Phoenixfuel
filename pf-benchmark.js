...
async function caricaBenchmark() {
  ...
  kpiWrap.innerHTML =
    ...
    '<div class="kpi"><div class="kpi-label">Prezzo vendita medio</div><div class="kpi-value" style="font-family:var(--font-mono)">€ ' + prezzoVenditaMedio.toFixed(4) + '</div><div style="font-size:10px;color:var(--text-muted);margin-top:2px">' + (markupVendita >= 0 ? '+' : '') + '€ ' + markupVendita.toFixed(4) + ' su benchmark</div></div>' +
    '<div class="kpi" style="background:#EAF3DE;border:0.5px solid #639922"><div class="kpi-label" style="color:#27500A">Spread totale</div><div class="kpi-value" style="font-family:var(--font-mono);color:#3B6D11">€ ' + spread.toFixed(4) + '/L</div><div style="font-size:10px;color:#3B6D11;margin-top:2px">' + (prezzoVenditaMedio > 0 ? (spread / prezzoVenditaMedio * 100).toFixed(1) + '% su vendita' : '') + '</div></div>';
  ...
  if (cmpCorrente > 0 && prezzoVenditaMedio > 0) {
    ...
    posWrap.innerHTML = '<div style="font-size:11px;font-weight:500;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.5px;margin-bottom:14px">Posizionamento prezzo — ' + prodotto + '</div>' +
      ...
      '<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px">' +
        '<div style="padding:8px 12px;border-left:3px solid #639922;background:var(--bg);border-radius:0 8px 8px 0"><div style="font-size:9px;color:var(--text-muted);text-transform:uppercase">Vantaggio acquisto</div><div style="font-size:15px;font-weight:600;color:#639922;font-family:var(--font-mono)">' + (vantaggioAcq >= 0 ? '−' : '+') + '€ ' + Math.abs(vantaggioAcq).toFixed(4) + '/L</div></div>' +
        '<div style="padding:8px 12px;border-left:3px solid #378ADD;background:var(--bg);border-radius:0 8px 8px 0"><div style="font-size:9px;color:var(--text-muted);text-transform:uppercase">Markup su benchmark</div><div style="font-size:15px;font-weight:600;color:#378ADD;font-family:var(--font-mono)">' + (markupVendita >= 0 ? '+' : '') + '€ ' + markupVendita.toFixed(4) + '/L</div></div>' +
        '<div style="padding:8px 12px;border-left:3px solid #6B5FCC;background:var(--bg);border-radius:0 8px 8px 0"><div style="font-size:9px;color:var(--text-muted);text-transform:uppercase">Spread totale</div><div style="font-size:15px;font-weight:600;color:#6B5FCC;font-family:var(--font-mono)">€ ' + spread.toFixed(4) + '/L</div></div>' +
      '</div>';
  } else {
