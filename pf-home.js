...
function _tickOrologio() {
  ...
  var elOra = document.getElementById('home-ora-dig'); if (elOra) elOra.textContent = String(h).padStart(2,'0') + ':' + String(m).padStart(2,'0');
  var elSec = document.getElementById('home-sec-dig'); if (elSec) { elSec.textContent = ':' + String(s).padStart(2,'0'); elSec.style.opacity = s % 2 === 0 ? '0.7' : '0.4'; }
