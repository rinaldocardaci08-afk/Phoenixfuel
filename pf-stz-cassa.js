// PhoenixFuel — Stazione: Cassa, Crediti, Differenze
...
// ── LETTURA SCONTRINO (OCR) — RIMOSSA IL 26/07 ─────────────────────
// Non ha mai funzionato in modo affidabile (regex sul totalizzatore e
// mappatura pompe) ed e stata sostituita dall'import dal portale Gilbarco:
// lo script sul PC deposita contatori, prezzi e cassa nelle tabelle di
// appoggio e le pagine li propongono con il pulsante "Carica dati dal
// portale". Rimosse: ocrScontrino, _parseScontrino, applicaOcrCassa,
// applicaOcrLetture, confermaOcrLetture e i pulsanti relativi.
// L'ALLEGA SCONTRINO (upload del file) resta: e un'altra cosa.
// ───────────────────────────────────────────────────────────────────
